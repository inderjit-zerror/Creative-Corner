...
const content = [
  ...
  "team of digital marketing strategists, ",
  "creatives, and tech savvy experts dedicated",
  "to helping brands thrive in the ever-evolving ",
  "world of social media and ",
  "online marketing.Founded with",
  "a vision to empower businesses ",
  "with powerful digital tools, we",
    ...
    <div className="w-[100vw] h-screen max-sm:h-fit justify-around items-center flex relative BGRED text-white">
      <div className="w-full h-fit flex justify-around max-sm:flex-col max-sm:px-5">
        <div className="text-[1.5vw] leading-[1.5vw] pt-[10vh] max-sm:text-[4.5vw] max-sm:leading-[5vw]">
          Hi, nice to meet you. <br /> This is the part where <br /> I talk
          about myself.
        ...
        <div className="flex flex-col relative">
          {content.map((item, i) => {
            return (
              <div
                key={i}
                className={`w-fit h-fit text-[2vw] leading-[2.5vw] max-sm:text-[4.5vw] max-sm:leading-[5vw] AboutLineDiv${i + 1} flex ${i === 4 && "pl-[9vw] max-sm:pl-[25vw]"} ${i === 5 && "pl-[9vw] max-sm:pl-[25vw]"} ${i === 6 && "pl-[9vw] max-sm:pl-[25vw]"} ${i === 7 && "pl-[9vw] max-sm:pl-[25vw]"} `}
              >
                {item}
              </div>
            );
          })}
          <div className=" absolute overflow-hidden top-[10.5vw] max-sm:w-[22vw] max-sm:h-[18vw] max-sm:top-[21vw] left-0 bg-amber-300 h-[9vw] w-[8vw]">
