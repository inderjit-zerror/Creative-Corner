...
const WorkSection = () => {
  ...
  return (
    <div
    id="work"
      className={` w-full h-fit WorkCONTDIV relative flex flex-col justify-center items-center bg-white pb-[10vh]`}
    >
      ...
      {videoData.map((item, index) => {
        return (
          <div key={index} className="w-1/3 max-sm:w-[95%] h-fit flex flex-col mt-10">
            ...
            <p className="Text_Color_B Font_Main text-[1.7vw] leading-[1.7vw] max-sm:text-[1.5rem] max-sm:leading-[1.5rem] pt-5 pb-2">
              Project ~ {index + 1}
            </p>
            <p className="Text_Color_B Font_Sec text-[1vw] leading-[1vw] max-sm:text-[1rem] max-sm:leading-[1rem] pb-5 ">
